...
export async function POST(req) {
  try {
    ...
    // 2. Lấy danh sách giải thưởng bằng Admin (Xuyên qua RLS bảng prizes)
    ...
    if (!allPrizes || allPrizes.length === 0) {
      console.error("LỖI: Bảng prizes trống!");
    ...
    // 5. Cập nhật lượt quay bằng Admin
